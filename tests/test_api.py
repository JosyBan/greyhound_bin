...
from custom_components.greyhound_bin.api import GreyhoundbinApiClient
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = GreyhoundbinApiClient("test", "test", async_get_clientsession(hass))
