...
class GreyhoundBinEntity(CoordinatorEntity[GreyhoundDataUpdateCoordinator]):
    """BlueprintEntity class."""
    ...
    def __init__(self, coordinator: GreyhoundDataUpdateCoordinator) -> None:
        ...
        self._attr_device_info = DeviceInfo(
            ...
            name="Greyhound Bin",  # This is what shows up as the device name
            manufacturer="Greyhound",
        )
